    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex font-bold mb-6 items-center">
                ...
                <span className="font-light ml-1">({data.ridesData.length} rides)</span>
            </div>
            <div className="border-b border-t border-neutral-300 py-2 mb-6">
                <p className="text-neutral-400 font-semibold text-sm">INSURANCE</p>
                <p className="font-light">Pedal Insurance</p>
            </div>
            <div className="flex gap-6 mb-6">
                {data.type === 'electric' ? 
                    <div className="flex text-gray-600 items-center -ml-1">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                        <p className="font mb-1 text-gray-500">{data.type}</p>
                    </div>
                : null}
                {data.delivery ? 
                    <div className="flex text-gray-600 items-center">
                        ...
                        <p className="font mb-1 text-gray-500">Pickup / Delivery</p>
                    </div> 
                    : null
                }
            </div>
            <div className="flex flex-col mb-10">
                <p className="font-semibold text-sm mb-2 tracking-wider text-gray-600">DESCRIPTION</p>
                <p className="font-light">{data.description}</p>
            </div>
            <div className="flex flex-col">
                <h4 className="font-semibold text-sm mb-2 tracking-wider text-gray-600">{`REVIEW & RATINGS`}</h4>
